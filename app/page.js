...
export default function Home() {
  const [items,setItems]=useState([
    ...
    //{name:'Movie', price:9.56},
    //{name:'Apples', price:3.23},
  ]);
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between sm:p-24 p-4">
      <div className="z-10 w-full max-w-5xl w-full items-center justify-between font-mono text-sm ">
       <h1 className='text-4xl p-4 text-center'>My Expenses</h1> 
